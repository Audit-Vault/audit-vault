...
function DeploymentsContent() {
  return (
    <div>
      <h2 className="text-3xl font-bold text-slate-900 mb-2">Deployments</h2>
      <p className="text-slate-600">Manage and track deployments across your infrastructure.</p>
    </div>
  );
}
...
function SystemsContent() {
  return (
    <div>
      <h2 className="text-3xl font-bold text-slate-900 mb-2">Systems</h2>
      <p className="text-slate-600">View and manage all monitored systems.</p>
    </div>
  );
}
...
function ReportsContent() {
  return (
    <div>
      ...
      <p className="text-slate-600">Generate and view security reports.</p>
    </div>
  );
}
...
function AgentsContent() {
  return (
    <div>
      <h2 className="text-3xl font-bold text-slate-900 mb-2">Agents</h2>
      <p className="text-slate-600">Manage security agents across your systems.</p>
    </div>
  );
}
...
function AdminContent() {
  return (
    <div>
      <h2 className="text-3xl font-bold text-slate-900 mb-2">Administration</h2>
      <p className="text-slate-600">Configure system settings and user management.</p>
    </div>
  );
}
...
function SupportContent() {
  return (
    <div>
      <h2 className="text-3xl font-bold text-slate-900 mb-2">Support</h2>
      <p className="text-slate-600">Get help and access documentation.</p>
    </div>
  );
}